...
<head>
    ...
    <title>Accessibility - Muzeul Tecuci</title>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto position-relative">
                    <div class="site-heading">
                        <h1><br><strong>Accessibility</strong><br></h1>
                    </div>
                </div>
            </div>
        </div>
    </header>
    <h3 style="color: #0085a1;text-align: center;font-family: 'Lora',serif;">Accessibility statement 2022</h3>
    ...
    <div class="container" style="text-align: center;">
        <div class="text_istoric">
            <div class="istoric_text_column istoric_content_element ">
                <div class="text_istoric">
                    <h2>Accessibility Statement for <span class="basic-information website-name">Muzeul de istorie "Teodor Cincu" Tecuci</span></h2>
                    <p>
                        This is an accessibility statement from <span class="basic-information organization-name">Muzeul de istorie "Teodor Cincu" Tecuci</span>.
                    </p>
                    ...
                    <p>
                        ...
                        <span class="basic-information website-name">Muzeul de istorie "Teodor Cincu" Tecuci</span>
                        is
                    ...
                    <ul class="basic-information feedback h-card">
                        <li>
                            Visitor Address:
                            <span class="visitor-address p-extended-address">Str. 1 Decembrie 1918, nr. 36, Tecuci, 805300, jud. Galati</span>
                        </li>
                        <li>
                            Postal Address:
                            <span class="postal-address p-adr">805300</span>
                        </li>
                    </ul>
                    <p>
                    ...
                    <p>
                        <span class="basic-information organization-name">Muzeul de istorie "Teodor Cincu" Tecuci</span>
                    ...
                    <p>
                        ...
                        <span class="basic-information statement-created-date">25 August 2022</span>
