...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">    <h3 style="color: #e2b13c;text-align: center;font-family: 'Lora',serif;">SCURT ISTORIC</h3>
    <h2 style="text-align: center;font-family: 'Poppins',sans-serif;"><br><strong>MUZEUL DE ISTORIE „TEODOR CINCU” TECUCI</strong><br><br></h2><div class="muzeu_text_column muzeu_content_element muzeu_animate_when_almost_visible muzeu_slideInRight slideInRight vc_custom_1508447400818 muzeu_start_animation animated"><div class="muzeu_wrapper"><h4>Edificiul în care funcţionează <strong>Muzeul de Istorie Teodor Cincu</strong> Tecuci , inclus în lista monumentelor istorice, categoria A, a fost construit în mai multe etape începând cu sfârşitul secolului al XIX-lea.</h4><p>În anul 1885, clădirea este amintită ca fiind în proprietatea lui Anton Cincu, om politic şi filantrop local, care o va lăsa prin testament, la 22 iulie 1894, fiului <span style="color: #333333;">Teodor Cincu</span>. Din punct de vedere arhitectural, se remarcă stilul baroc, predominant în prima etapă a construcţiei,</p><p>, când accesul se făcea dinspre sud, un turnuleţ pe care era inserat medalionul cu blazonul familiei străjuind intrarea în casă.</p><p>La începutul secolului al XX-lea, s-au modificat faţadele casei, accesul principal fiind orientat spre est şi tratat în stil neoclasic. Un fronton&nbsp; susţinut de patru coloane corintice marchează ….</p></div></div><div class="vc_wp_text muzeu_content_element"><div class="widget widget_text"><div class="textwidget"><p></p><p style="text-align: center;"><a href="istoric.html" rel="noopener"><span style="color: #ff9900;">&nbsp;Citeste mai multe&nbsp;→</span></a></p><p></p></div></div></div></div></div>
        </div>
    </div><!-- End: 1 Row 2 Columns -->
    <h3 style="color: #e2b13c;text-align: center;font-family: 'Lora',serif;"><br><strong>SECTIUNEA BLOG A WEBSITE-ULUI</strong><br></h3>
