...
<body>
    ...
    <header class="masthead" style="background-image:url('assets/img/program.jpg');     background-attachment: fixed;
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto position-relative">
                    <div class="site-heading">
                        <h1><br><strong class="aici-alb"></strong><br></h1>
                    </div>
                </div>
            </div>
        </div>
    </header>
    <h3 style="color: #17AA4B;text-align: center;font-family: 'Lora',serif;">Program vizitare</h3>
    ...
    <div class="container" style="text-align: center;">
        <div class="text_istoric">
            <div class="istoric_text_column istoric_content_element ">
                <div class="text_istoric">
                    <p>
                        Noiembrie-Aprilie : miercuri – duminică în intervalul orar 09:00-17:00
                    </p>
                    <p>
                        Mai-Octombrie: miercuri – duminică în intervalul orar 10:00 – 18:00
                    </p>
                    <p>
