            ...
            <ul class="navbar-nav ms-auto"></ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="colectie.php?sect=arheologie">Arheologie</a>
                        <a class="dropdown-item" href="colectie.php?sect=numismatica">Numismatică</a>
                        <a class="dropdown-item" href="colectie.php?sect=arta">Arta</a>
                        <a class="dropdown-item" href="colectie.php?sect=etnografie">Etnografie</a>
                        <a class="dropdown-item" href="colectie.php?sect=donatii">Donatii si donatori</a>
                        <a class="dropdown-item" href="colectie.php?sect=aumobilul">Aumobilul Ego</a>
                    </div>
                </li>
                </li><!-- End: Sectiuni -->
                <!-- Start: Evenimente -->
